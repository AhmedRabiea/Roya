...
const Ambitious = () => {
  return (
    <section id="ambitous" className="mt-20 lg:mt-36">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-3 gap-10 bg-gradient-to-br from-[#6D6D6D] to-[#11101D] rounded-lg p-10 lg:p-20 items-center justify-center">
          <div className="lg:col-span-2">
            <h1 className="text-xl lg:text-5xl">Let’s try our service now!</h1>
